...
<%@page import="com.danny.web.entity.Notice"%>
		...
		<div class="content-container clearfix">
			...
			<main class="main">
				...
				<form action="list" method="POST">
					<div class="notice margin-top">
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td>${n.id}</td>
									<td class="title indent text-align-left "><a href="detail?id=${n.id}">${n.title}</a><span class="text-orange text-strong">[${n.cmtCount}]</span></td>
									<td>${n.writerId}</td>
									<td><fmt:formatDate pattern="yyyy-MM-dd" value="${n.regdate}"/></td>
									<td>${n.hit}</td>
									
									<c:set var="open" value="checked"></c:set>
									<td><input type="checkbox" ${(n.pub)?open:""} name="open-id" value="${n.id}"></td>
					...
					<%-- <c:set var="lastNum" value="${(count<=10)?1:fn:substringBefore(Math.ceil(count/10),'.')}"/> --%>
				...
				<div class="margin-top align-center pager">	
					...
					<div>
						...
						<a href="?p=${5+startNum}&t=&q=" class="btn btn-prev">다음</a>
						</c:if>
